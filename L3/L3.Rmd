...
The following chart displays the total number of diacars the `diampgataset, grouped by `cutdrv
```{r}
ggplot(data = diampg 
  geom_bar(mapping = aes(x = cutdrv```

You can change the colors.
```{r}
ggplot(data = diampg 
  geom_bar(mapping = aes(x = cutdrvill = cutdrv```
