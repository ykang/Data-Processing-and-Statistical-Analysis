...
2. How many paragraphs is there in the article?

3. Trim leading whitespaces of each paragraph.

4. How many characters is there in the article?
...
<!-- 98 Create a function that takes a string and returns it in reversed order by words (Hint: split the string according to a blank space ` '. Then count the number of components resulting from the splitting step. Re-arrenge them in reverse order and paste them in a single string.) -->
